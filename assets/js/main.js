...
function addFeaturedProjects(grid) {
  const featured = [
    ...
    },
    {
      ...
      desc: 'Statistically-driven stock portfolio optimization integrating historic indicators into an attractiveness scoring algorithm with regime detection and walk-forward validation.',
      lang: 'Python',
      color: '#3572A5',
      icon: '📊',
